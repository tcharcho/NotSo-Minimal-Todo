...
public class ReminderFragment extends AppDefaultFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        app = (AnalyticsApplication) activity.getApplication();
        app.send(this);
        ...
        boardID = (UUID) i.getSerializableExtra(TodoNotificationService.BOARDUUID);
        ...
        snoozeOptions = getResources().getStringArray(R.array.snooze_options);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.spinner_text_view, snoozeOptions);
    ...
    private void closeApp() {
        ...
        SharedPreferences sharedPreferences = activity.getSharedPreferences(MainFragment.SHARED_PREF_DATA_SET_CHANGED, MODE_PRIVATE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if ((activity = getActivity()) != null) {
            activity.getMenuInflater().inflate(R.menu.menu_reminder, menu);
            return true;
        }
        return false;
    }
